...
AKingActor::AKingActor()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> FoundMesh(TEXT("StaticMesh'/Game/Meshes/King.King'"));
...
*/
void AKingActor::DetectSelectableGrids(TArray<UStaticMeshComponent*> *SelectableGrids, TArray<UMaterial*> *DefaultMaterials)
{
	FVector SpawnLocation = FVector(GetActorLocation().X, GetActorLocation().Y, 0);
	CheckOverlap(SpawnLocation + FVector(400.0f, 0.0f, 0.0f), SelectableGrids, DefaultMaterials);
	CheckOverlap(SpawnLocation + FVector(-400.0f, 0.0f, 0.0f), SelectableGrids, DefaultMaterials);

	CheckOverlap(SpawnLocation + FVector(0.0f, 400.0f, 0.0f), SelectableGrids, DefaultMaterials);
	CheckOverlap(SpawnLocation + FVector(0.0f, -400.0f, 0.0f), SelectableGrids, DefaultMaterials);

	CheckOverlap(SpawnLocation + FVector(400.0f, 400.0f, 0.0f), SelectableGrids, DefaultMaterials);
	CheckOverlap(SpawnLocation + FVector(-400.0f, -400.0f, 0.0f), SelectableGrids, DefaultMaterials);
...
@param DefaultGrids:	Pointer variable to assign material values of selectable grids.
*/
void AKingActor::CheckOverlap(FVector SpawnLocation, TArray<UStaticMeshComponent*> *SelectableGrids, TArray<UMaterial*> *DefaultMaterials)
{
...
*/
void AKingActor::AddAndHighlight(TArray<UStaticMeshComponent*> *SelectableGrids, TArray<UMaterial*> *DefaultMaterials, TArray<AActor*> *OverlappedActors, TArray<UPrimitiveComponent*> *OverlappedComponents)
{
